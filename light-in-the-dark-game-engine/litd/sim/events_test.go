...
func TestBuiltinEventKindsUnique(t *testing.T) {
	kinds := map[string]uint16{
		...
		"EvHeroLevel":          EvHeroLevel,
		"EvHeroDied":           EvHeroDied,
		"EvItemPickedUp":       EvItemPickedUp,
		"EvItemUsed":           EvItemUsed,
		"EvItemDropped":        EvItemDropped,
		"EvConstructStarted":   EvConstructStarted,
		"EvConstructFinished":  EvConstructFinished,
		"EvConstructCancelled": EvConstructCancelled,
		"EvMissileImpact":      EvMissileImpact,
		"EvMissileExpired":     EvMissileExpired,
		"EvVictory":            EvVictory,
		"EvDefeat":             EvDefeat,
	}
