...
go test -short ./...    # inner-loop: heavy 10k/5k-tick e2e + determinism + stress
                        ...
                        # core 10k sim + AI golden determinism subtest once as
                        # explicit steps.
...
is a determinism fixture, decide whether it is a fast core gate or a full-only
edge sweep, then document that split in `scripts/preflight.sh`.
