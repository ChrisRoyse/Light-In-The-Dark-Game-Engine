...
var knownEventKinds = map[string]bool{
	...
	// ability/attack/buff lifecycle kinds (#470, exposing #467/#468/#469).
	"EventAbilityCast": true, "EventAbilityEffect": true, "EventAbilityChannelStart": true,
	"EventAbilityChannelStop": true, "EventAbilityFinish": true, "EventAbilityStopped": true,
	"EventAttackLaunch": true, "EventAttackLanded": true,
	"EventBuffApplied": true, "EventBuffRefreshed": true,
}
...
var eventCoverage = map[string]eventVerdict{
	...
	"EVENT_PLAYER_UNIT_ATTACKED":            mapped("EventAttackLaunch"),
	"EVENT_PLAYER_UNIT_DAMAGING":            tombstone(rsnDamaging),
	"EVENT_PLAYER_UNIT_SPELL_CAST":          mapped("EventAbilityCast"),
	"EVENT_PLAYER_UNIT_SPELL_CHANNEL":       mapped("EventAbilityChannelStart"),
	"EVENT_PLAYER_UNIT_SPELL_EFFECT":        mapped("EventAbilityEffect"),
	"EVENT_PLAYER_UNIT_SPELL_ENDCAST":       mapped("EventAbilityStopped"),
	"EVENT_PLAYER_UNIT_SPELL_FINISH":        mapped("EventAbilityFinish"),
	...
	"EVENT_UNIT_ATTACKED":            mapped("EventAttackLaunch"),
	...
	"EVENT_UNIT_SPELL_CAST":          mapped("EventAbilityCast"),
	"EVENT_UNIT_SPELL_CHANNEL":       mapped("EventAbilityChannelStart"),
	"EVENT_UNIT_SPELL_EFFECT":        mapped("EventAbilityEffect"),
	"EVENT_UNIT_SPELL_ENDCAST":       mapped("EventAbilityStopped"),
	"EVENT_UNIT_SPELL_FINISH":        mapped("EventAbilityFinish"),
