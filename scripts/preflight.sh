...
step "PRD2 primitive acceptance (timers/groups/kv)" go test ./litd/sim/ -run 'TestTimerScenarioGolden|TestGroupScenarioGolden|TestGroupSaveResumeParity|TestGroupTwoRunDeterminism|TestKVScenarioGolden|TestKVSaveResumeParity|TestKVUserDataMigrationSaveLoad' -count=1
